export const tabs = [
  ...
  },
  {
    ...
    id: 4,
    hideAt: 2.1,
    condition: () => player.records.totalAntimatter.gte(1e40) || MendingMilestone.one.isReached,
    hidable: true,
    subtabs: [
      {
        key: "autobuyers",
  ...
  },
  {
    ...
    subtabs: [
      ...
      },
      {
        ...
        condition: () => TeresaUnlocks.effarig.isUnlocked || MendingMilestone.twelve.isReached,
        id: 2,
        hidable: true,
      },
      {
        ...
        condition: () => EffarigUnlock.eternity.isUnlocked || MendingMilestone.twelve.isReached,
        id: 3,
        hidable: true,
      },
      {
        ...
        symbol: "⌬",
        component: "VTab",
        condition: () => Achievement(151).isUnlocked || MendingMilestone.five.isReached,
        id: 4,
        hidable: true,
      },
      {
