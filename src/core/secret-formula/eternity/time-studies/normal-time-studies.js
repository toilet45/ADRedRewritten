...
export const normalTimeStudies = [
  ...
  },
  {
    ...
    cost: DC.D0,
    STCost: 12,
    requirement: [() => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 10, 143],
    reqType: TS_REQUIREMENT_TYPE.ALL,
    requiresST: [143],
  ...
  },
  {
    ...
    cost: DC.D0,
    STCost: 12,
    requirement: [() => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 11, 101],
    reqType: TS_REQUIREMENT_TYPE.ALL,
    requiresST: [101],
  ...
  },
  {
    ...
    cost: DC.D0,
    STCost: 12,
    requirement: [() => Ra.unlocks.unlockHardV.effectOrDefault(0) >= 12, 102],
    reqType: TS_REQUIREMENT_TYPE.ALL,
    requiresST: [102],
