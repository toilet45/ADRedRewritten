...
export const alchemyResources = {
  ...
  "power": {
    ...
    symbol: "Ω",
    isBaseResource: true,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 32000 : 200000).add(1),
    tier: 1,
    uiOrder: 1,
    unlockedAt: 2,
  ...
  "infinity": {
    ...
    symbol: "∞",
    isBaseResource: true,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 75000 : 200000).add(1),
    tier: 1,
    uiOrder: 2,
    unlockedAt: 3,
  ...
  "time": {
    ...
    symbol: "Δ",
    isBaseResource: true,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 95000 : 200000).add(1),
    tier: 1,
    uiOrder: 3,
    unlockedAt: 4,
  ...
  "replication": {
    ...
    symbol: "Ξ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount.div(CelestialStudy(42).isBought ? 256 : 1000)),
    tier: 1,
    uiOrder: 4,
    unlockedAt: 5,
  ...
  "cardinality": {
    ...
    effect: amount => Decimal.div(CelestialStudy(42).isBought ? 0.55 : 0.2, amount.div(CelestialStudy(42).isBought ? 2048 : 20000).add(1)).add(1).clampMin(1.00005),
    tier: 2,
    uiOrder: 3,
    unlockedAt: 8,
  ...
  "eternity": {
    ...
    symbol: "τ",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 6450 : 15000).add(1),
    tier: 2,
    uiOrder: 2,
    unlockedAt: 9,
  ...
  "dimensionality": {
    ...
    symbol: "ρ",
    isBaseResource: false,
    effect: amount => Decimal.pow10(CelestialStudy(42).isBought ? amount.pow(7.25) : amount.times(5)),
    tier: 2,
    uiOrder: 1,
    unlockedAt: 10,
  ...
  "inflation": {
    ...
    symbol: "λ",
    isBaseResource: false,
    effect: amount => [Decimal.max(1.05, amount.div(CelestialStudy(42).isBought ? 8000 : 21000).root(CelestialStudy(42).isBought ? 3 : 4)),
  ...
  "alternation": {
    ...
    symbol: "ω",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 33333 : 200000),
    tier: 2,
    uiOrder: 4,
    unlockedAt: 12,
  ...
  "effarig": {
    ...
    symbol: "Ϙ",
    isBaseResource: true,
    effect: amount => Decimal.pow(CelestialStudy(42).isBought ? 12 : 10, amount.div(CelestialStudy(42).isBought ? 750 : 2500)),
    tier: 1,
    uiOrder: 1.5,
    unlockedAt: 7,
  ...
  "synergism": {
    ...
    isBaseResource: false,
    effect: amount => {
      const rawValue = Decimal.sqrt(amount.div(CelestialStudy(42).isBought ? 12345 : 25000)).mul(CelestialStudy(42).isBought ? 1.7 : 1.3).add(CelestialStudy(42).isBought ? 0.8 : 0.3);
  ...
  "momentum": {
    ...
    symbol: "μ",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 32767 : 125000).add(1),
    tier: 3,
    uiOrder: 3,
    unlockedAt: 15,
  ...
  "decoherence": {
    ...
    symbol: "ξ",
    isBaseResource: false,
    effect: amount => Decimal.sqrt(amount.div(CelestialStudy(42).isBought ? 9000 : 25000)).mul(CelestialStudy(42).isBought ? 0.55 : 0.15),
    tier: 3,
    uiOrder: 4,
    unlockedAt: 14,
  ...
  "exponential": {
    ...
    symbol: "Γ",
    isBaseResource: false,
    effect: amount => Decimal.pow(amount.div(CelestialStudy(42).isBought ? 4200 : 10000), CelestialStudy(42).isBought ? 3 : 2).mul(CelestialStudy(42).isBought ? 12 : 10),
    tier: 4,
    uiOrder: 2,
    unlockedAt: 18,
  ...
  "force": {
    ...
    symbol: "Φ",
    isBaseResource: false,
    effect: amount => Decimal.max(amount, amount.div(CelestialStudy(42).isBought ? 9595 : 25000).pow(CelestialStudy(42).isBought ? 3 : 2).mul(CelestialStudy(42).isBought ? 8000 : 25000)).mul(CelestialStudy(42).isBought ? 20 : 5),
    tier: 4,
    uiOrder: 2,
    unlockedAt: 17,
  ...
  "uncountability": {
    ...
    symbol: "Θ",
    isBaseResource: false,
    effect: amount => Decimal.sqrt(Decimal.max(amount, amount.div(CelestialStudy(42).isBought ? 4000 : 25000).pow(CelestialStudy(42).isBought ? 5 : 4).mul(CelestialStudy(42).isBought ? 5000 : 25000))).mul(CelestialStudy(42).isBought ? 400 : 160),
    tier: 4,
    uiOrder: 3,
    unlockedAt: 19,
  ...
  "boundless": {
    ...
    symbol: "Π",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 30000 : 80000),
    tier: 4,
    uiOrder: 1,
    unlockedAt: 20,
  ...
  "multiversal": {
    ...
    isBaseResource: false,
    effect: amount => {
      const x = CelestialStudy(42).isBought ? 120 : 32;
      const y = CelestialStudy(42).isBought ? 12345 : 25000;
  ...
  "unpredictability": {
    ...
    effect: amount => amount.div(CelestialStudy(42).isBought ? amount.sub(9275) : amount.add(10714.28)),
    tier: 4,
    uiOrder: 4,
    unlockedAt: 21,
