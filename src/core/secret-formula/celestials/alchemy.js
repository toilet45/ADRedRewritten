...
export const alchemyResources = {
  ...
  "power": {
    ...
    symbol: "Ω",
    isBaseResource: true,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 100000 : 200000).add(1),
    tier: 1,
    uiOrder: 1,
    unlockedAt: 2,
  ...
  "infinity": {
    ...
    symbol: "∞",
    isBaseResource: true,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 112233 : 200000).add(1),
    tier: 1,
    uiOrder: 2,
    unlockedAt: 3,
  ...
  "time": {
    ...
    symbol: "Δ",
    isBaseResource: true,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 123456 : 200000).add(1),
    tier: 1,
    uiOrder: 3,
    unlockedAt: 4,
  ...
  "replication": {
    ...
    symbol: "Ξ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount.div(CelestialStudy(42).isBought ? 420.69 : 1000)),
    tier: 1,
    uiOrder: 4,
    unlockedAt: 5,
  ...
  "dilation": {
    ...
    symbol: "Ψ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount.div(CelestialStudy(42).isBought ? 450 : 2000)),
    tier: 1,
    uiOrder: 5,
    unlockedAt: 6,
  ...
  "cardinality": {
    ...
    effect: amount => Decimal.div(CelestialStudy(42).isBought ? 0.25 : 0.2, amount.div(CelestialStudy(42).isBought ? 2048 : 20000).add(1)).add(1).clampMin(1.00005),
    tier: 2,
    uiOrder: 3,
    unlockedAt: 8,
  ...
  "eternity": {
    ...
    symbol: "τ",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 7650 : 15000).add(1),
    tier: 2,
    uiOrder: 2,
    unlockedAt: 9,
  ...
  "dimensionality": {
    ...
    symbol: "ρ",
    isBaseResource: false,
    effect: amount => Decimal.pow10(CelestialStudy(42).isBought ? amount.pow(6.66) : amount.times(5)),
    tier: 2,
    uiOrder: 1,
    unlockedAt: 10,
  ...
  "inflation": {
    ...
    symbol: "λ",
    isBaseResource: false,
    effect: amount => [Decimal.max(1.05, amount.div(CelestialStudy(42).isBought ? 11100 : 21000).root(CelestialStudy(42).isBought ? 3.95 : 4)),
  ...
  "alternation": {
    ...
    symbol: "ω",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 100000 : 200000),
    tier: 2,
    uiOrder: 4,
    unlockedAt: 12,
  ...
  "effarig": {
    ...
    symbol: "Ϙ",
    isBaseResource: true,
    effect: amount => Decimal.pow(CelestialStudy(42).isBought ? 11 : 10, amount.div(CelestialStudy(42).isBought ? 1850 : 2500)),
    tier: 1,
    uiOrder: 1.5,
    unlockedAt: 7,
  ...
  "synergism": {
    ...
    isBaseResource: false,
    effect: amount => {
      const rawValue = Decimal.sqrt(amount.div(CelestialStudy(42).isBought ? 22222 : 25000)).mul(CelestialStudy(42).isBought ? 1.5 : 1.3).add(CelestialStudy(42).isBought ? 0.333 : 0.3);
  ...
  "momentum": {
    ...
    symbol: "μ",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 88888 : 125000).add(1),
    tier: 3,
    uiOrder: 3,
    unlockedAt: 15,
  ...
  "decoherence": {
    ...
    symbol: "ξ",
    isBaseResource: false,
    effect: amount => Decimal.sqrt(amount.div(CelestialStudy(42).isBought ? 13370 : 25000)).mul(CelestialStudy(42).isBought ? 0.3 : 0.15),
    tier: 3,
    uiOrder: 4,
    unlockedAt: 14,
  ...
  "exponential": {
    ...
    symbol: "Γ",
    isBaseResource: false,
    effect: amount => Decimal.pow(amount.div(CelestialStudy(42).isBought ? 9001 : 10000), CelestialStudy(42).isBought ? 2.147 : 2).mul(CelestialStudy(42).isBought ? 11 : 10),
    tier: 4,
    uiOrder: 2,
    unlockedAt: 18,
  ...
  "force": {
    ...
    symbol: "Φ",
    isBaseResource: false,
    effect: amount => Decimal.max(amount, amount.div(CelestialStudy(42).isBought ? 18500 : 25000).pow(CelestialStudy(42).isBought ? 2.15 : 2).mul(CelestialStudy(42).isBought ? 18500 : 25000)).mul(CelestialStudy(42).isBought ? 7 : 5),
    tier: 4,
    uiOrder: 2,
    unlockedAt: 17,
  ...
  "uncountability": {
    ...
    symbol: "Θ",
    isBaseResource: false,
    effect: amount => Decimal.sqrt(Decimal.max(amount, amount.div(CelestialStudy(42).isBought ? 22500 : 25000).pow(CelestialStudy(42).isBought ? 4.2 : 4).mul(CelestialStudy(42).isBought ? 22500 : 25000))).mul(CelestialStudy(42).isBought ? 250 : 160),
    tier: 4,
    uiOrder: 3,
    unlockedAt: 19,
  ...
  "boundless": {
    ...
    symbol: "Π",
    isBaseResource: false,
    effect: amount => amount.div(CelestialStudy(42).isBought ? 31337 : 80000),
    tier: 4,
    uiOrder: 1,
    unlockedAt: 20,
  ...
  "multiversal": {
    ...
    isBaseResource: false,
    effect: amount => {
      const x = CelestialStudy(42).isBought ? 69 : 32;
      const y = CelestialStudy(42).isBought ? 21474 : 25000;
      // eslint-disable-next-line no-unused-expressions
      return (Decimal.pow(amount.div(y), 2).mul(x).gt(x)
        ? Decimal.pow(amount.div(y), 2).mul(x).sub(x).cbrt().add(x)
        : Decimal.pow(amount.div(y), 2).mul(x));
    },
    tier: 4,
    uiOrder: 5,
    unlockedAt: 16,
  ...
  "unpredictability": {
    ...
    // is there code for > 100 % i.e 2+ retriggers?
    effect: amount => amount.div(CelestialStudy(42).isBought ? amount.sub(4444) : amount.add(10714.28)),
    tier: 4,
    uiOrder: 4,
    unlockedAt: 21,
  ...
  "reality": {
    ...
    symbol: "Ϟ",
    isBaseResource: false,
    effect: amount => Decimal.floor(amount), // x1.33 with CS42?
    tier: 5,
    unlockedAt: 25,
