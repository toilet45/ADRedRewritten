...
export const normalAchievements = [
  ...
  },
  {
    ...
    checkRequirement: () => AchievementTimers.marathon2
      .check(
        !EternityChallenge(7).isRunning && !EternityChallenge(19).isRunning &&
  ...
  },
  {
    ...
    checkRequirement: () => Object.values(player.reality.glyphs.sac).toSpliced(7, 1).every(s => s.gt(0)),
    checkEvent: GAME_EVENT.GLYPHS_CHANGED,
  ...
  },
  {
    ...
    checkRequirement: () => AlchemyResources.all.every(x => x.amount.gte(25000)),
    checkEvent: GAME_EVENT.REALITY_RESET_AFTER,
    get reward() {
  ...
  },
  {
    ...
    get description() {
      return `Reach a Glyph Sacrifice Cap of atleast ${format(DC.NUMMAX, 2, 2)}`;
    },
