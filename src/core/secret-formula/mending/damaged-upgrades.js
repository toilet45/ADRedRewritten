...
export const damagedUpgrades = [
  rebuyable({
    ...
    id: 1,
    costs: () => [new Decimal(2), new Decimal(2)],
  ...
  rebuyable({
    ...
    id: 2,
    costs: () => [new Decimal(0), new Decimal(5)],
  ...
  rebuyable({
    ...
    id: 3,
    costs: () => [new Decimal(10), new Decimal(0)],
  ...
  rebuyable({
    name: "Dark Gravity",
    id: 4,
    costs: () => [new Decimal(100), new Decimal(100)],
  ...
  rebuyable({
    name: "Unit 08",
    id: 5,
    costs: () => [new Decimal(50), new Decimal(0)],
  ...
  }),
  {
    name: "???",
    id: 6,
    costs: () => [new Decimal(1000), new Decimal(1000)],
