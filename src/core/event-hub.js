...
window.GAME_EVENT = {
  ...
  // AD:Redemption Events
  AD_RED_MENDING_RESET_BEFORE: "AD_RED_MENDING_RESET_BEFORE",
  AD_RED_MENDING_RESET_AFTER: "AD_RED_MENDING_RESET_AFTER",
  AD_RED_MENDING_UPGRADE_BOUGHT: "AD_RED_MENDING_UPGRADE_BOUGHT",
};
