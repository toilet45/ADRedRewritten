...
class ImaginaryBlackHoleUpgradeState {
  ...
  get isAffordable() {
    return Currency.imaginaryMachines.gte(this.cost);
  }
...
export const ImaginaryBlackHoles = {
  ...
  timeToNextPause(bhNum, steps = 100) {
    ...
    const phaseBoundList = [[intervals[0]], [durations[0]]];
    // Time tracking.
