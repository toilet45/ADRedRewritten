...
TimeStudy.allConnections = (function() {
  ...
  const connections = [
    ...
    [TS(61), TS(72)],
    [TS(61), TS(73)],
    [TS(61), TS(74), () => (Ra.pets.laitela.level >= 75 && Ra.pets.pelle.level >= 30)],

    [TS(71), TS(81)],
    [TS(72), TS(82)],
    [TS(73), TS(83)],
    [TS(74), TS(84), () => (Ra.pets.laitela.level >= 75 && Ra.pets.pelle.level >= 30)],

    [TS(81), TS(91)],
    [TS(82), TS(92)],
    [TS(83), TS(93)],
    [TS(84), TS(94), () => (Ra.pets.laitela.level >= 75 && Ra.pets.pelle.level >= 30)],

    [TS(91), TS(101)],
    [TS(92), TS(102)],
    [TS(93), TS(103)],
    [TS(94), TS(104), () => (Ra.pets.laitela.level >= 75 && Ra.pets.pelle.level >= 30)],
    ...
    [TS(104), TS(324), () => ((Ra.unlocks.unlockHardV.effectOrDefault(0) && Ra.unlocks.MvDUnlock.canBeApplied) >= 15 && Ra.pets.laitela.level >= 75 && Ra.pets.pelle.level >= 30)],
