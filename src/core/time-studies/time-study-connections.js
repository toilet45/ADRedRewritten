...
TimeStudy.allConnections = (function() {
  ...
  const connections = [
    ...
    [TS(61), TS(72)],
    [TS(61), TS(73)],
    [TS(61), TS(74), () => !(Ra.unlocks.MvDUnlock.canBeApplied && Ra.unlocks.dimStudyPath.canBeApplied)],

    [TS(71), TS(81)],
    [TS(72), TS(82)],
    [TS(73), TS(83)],
    [TS(74), TS(84), () => !(Ra.unlocks.MvDUnlock.canBeApplied && Ra.unlocks.dimStudyPath.canBeApplied)],

    [TS(81), TS(91)],
    [TS(82), TS(92)],
    [TS(83), TS(93)],
    [TS(84), TS(94), () => !(Ra.unlocks.MvDUnlock.canBeApplied && Ra.unlocks.dimStudyPath.canBeApplied)],

    [TS(91), TS(101)],
    [TS(92), TS(102)],
    [TS(93), TS(103)],
    [TS(94), TS(104), () => !(Ra.unlocks.MvDUnlock.canBeApplied && Ra.unlocks.dimStudyPath.canBeApplied)],
    ...
    [TS(104), TS(111), () => !(Ra.unlocks.MvDUnlock.canBeApplied && Ra.unlocks.unlockHardV.effectOrDefault(0) < 15 && Ra.unlocks.dimStudyPath.canBeApplied)],
    [TS(104), TS(324), () => !(Ra.unlocks.MvDUnlock.canBeApplied && (Ra.unlocks.unlockHardV.effectOrDefault(0) >= 15) && Ra.unlocks.dimStudyPath.canBeApplied)],
    [TS(324), TS(111), () => !(Ra.unlocks.MvDUnlock.canBeApplied && (Ra.unlocks.unlockHardV.effectOrDefault(0) >= 15))],
