...
TimeStudy.allConnections = (function() {
  ...
  const connections = [
    ...
    [TS(104), TS(111), () => (Ra.pets.v.level >= 75 && Ra.pets.laitela.level >= 75)],
    //[TS(104), TS(324), () => !(Ra.pets.v.level >= 75 && Ra.pets.laitela.level >= 75)],
    //[TS(324), TS(111), () => !(Ra.pets.v.level >= 75 && Ra.pets.laitela.level >= 75)],
