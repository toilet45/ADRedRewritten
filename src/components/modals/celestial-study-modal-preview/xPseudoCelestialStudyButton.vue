...
export default {
  name: "PseudoCelestialStudyButton",
  props: {
    setup: {
      type: Object,
      required: true
  ...
  computed: {
    ...
    studyString() {
      switch (this.study.type) {
        case CELESTIAL_STUDY_TYPE.NORMAL: return `${this.study.id}`;
        case CELESTIAL_STUDY_TYPE.ETERNITY_CHALLENGE: return `EC${this.study.id}`;
      }
      return "";
    }
  },
